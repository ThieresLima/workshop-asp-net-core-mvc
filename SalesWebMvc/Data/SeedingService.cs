...
namespace SalesWebMvc.Data
{
    ...
    {
        private SalesWebMvcContext _context;     // registrar uma depencia do seedingService com DbContext

        public SeedingService(SalesWebMvcContext context)  // indica que a injeção deve acontecer
        {
            _context = context;
        }

        public void Seed()      // testando se tem alguma coisa na base de dados
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2); Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            ...
            SalesRecord r1 = new SalesRecord(1, new DateTime(2018, 09, 25), 110000.0, SaleStatus.Billed, s1);
...
// registrar uma depencia do seedingService com DbContext